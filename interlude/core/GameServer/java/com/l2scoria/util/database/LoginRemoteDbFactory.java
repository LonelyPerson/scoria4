...
{
	private static final Logger _log = Logger.getLogger(LoginRemoteDbFactory.class.getName());
	...
	// =========================================================
	// Data Field
	private static LoginRemoteDbFactory _instance;
	private ProviderType _providerType;
	private ComboPooledDataSource _source;

	// =========================================================
	// Constructor
	public LoginRemoteDbFactory() throws SQLException
	{
		try
		{
			...
			_source.setMaxPoolSize(Config.RL_DATABASE_MAX_CONNECTIONS);

			_source.setAcquireRetryAttempts(0); // try to obtain connections indefinitely (0 = never quit)
			_source.setAcquireRetryDelay(500); // 500 miliseconds wait before try to acquire connection again
			_source.setCheckoutTimeout(Config.RL_DATABASE_TIMEOUT); // 0 = wait indefinitely for new connection
			...
			_source.setAutomaticTestTable("rl_connection_test_table");
			...
			_source.setMaxStatementsPerConnection(Config.RL_DATABASE_STATEMENT);
			...
			_source.setDriverClass(Config.RL_DATABASE_DRIVER);
			_source.setJdbcUrl(Config.RL_DATABASE_URL);
			_source.setUser(Config.RL_DATABASE_LOGIN);
			_source.setPassword(Config.RL_DATABASE_PASSWORD);
	...
	// =========================================================
	// Property - Public
	public static LoginRemoteDbFactory getInstance() throws SQLException
	{
		if(_instance == null)
		{
			_instance = new LoginRemoteDbFactory();
		}
		return _instance;
	}
