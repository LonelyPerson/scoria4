...
public final class CustomNpcInstanceManager
{
	...
	private FastMap<Integer, customInfo> templates; // <Npc Id , info>
	...
	public final class customInfo
	{
		...
		public int integerData[] = new int[26];
		public boolean booleanData[] = new boolean[6];
	}
	 ...
	 * @return
	 */
	public final boolean isThisL2CustomNpcInstance(int npcId)
	{
		if(npcId == 0)
			return false;
	 ...
	 */
	public final customInfo getCustomData(int npcId)
	{
		if(npcId == 0)
			return null;
	...
	{
		String Query = "REPLACE INTO npc_to_pc_polymorph VALUES template,name,title,class_id,female,hair_style,hair_color,face,name_color,title_color," +
		" noble,hero,pvp,karma,wpn_enchant,right_hand,left_hand,gloves,chest,legs,feet,hair,hair2, pledge,cw_level,clan_id,ally_id,clan_crest,ally_crest,rnd_class,rnd_appearance,max_rnd_enchant" + 
		" FROM npc_to_pc_polymorph";
