...
public final class L2World
{
	...
	private L2WorldRegion[][] _worldRegions;
        ...
        public int radiusVisibleObject = 2000;
	...
	{
		L2Object tmp = _allObjects.get(object.getObjectId());
		if(tmp != null)
		{
	 ...
	 * @param name Name of the player to get Instance
	 */
	public L2PcInstance getPlayer(int charId)
	{
		for(L2PcInstance player : _allPlayers.values())
		{
			if(player!= null && player.getObjectId() == charId)
				return player;
		}
		return null;
	}
	...
	public void addVisibleObject(L2Object object, L2WorldRegion newRegion, L2Character dropper)
	{
		...
		// in a circular area of 2000 units
                if(Config.ENABLE_VISIBLE_OBJECT_OPTIMIZATION && getAllPlayersCount() > Config.VISIBLE_DEECREASE_VALUE_ONLINE) {
                    radiusVisibleObject = Config.RADIUS_VISIBLE_DEECREASE_VALUE;
                }
