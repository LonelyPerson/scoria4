...
public class Instance
{
	...
	{
		return _questStarter.size() > 0 && _questStarter.contains(par);
	}
	...
	protected void doCheckTimeUp(int remaining)
	{
		...
		else if (remaining > 30000)
		{
			...
			interval = 30000;
			cs = new CreatureSay(0, CreatureSay.SystemChatChannelId.Chat_Alliance, "Notice", timeLeft + " seconds left.");
	...
	private class SoloKamaFinishFigh implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.error("Unable to create a kamaloka Npc!", e);
			}
		}
	}
