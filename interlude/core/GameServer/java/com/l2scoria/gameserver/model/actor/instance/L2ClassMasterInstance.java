...
public final class L2ClassMasterInstance extends L2FolkInstance
{
	...
	public static L2ClassMasterInstance ClassMaster = new L2ClassMasterInstance(31227, NpcTable.getInstance().getTemplate(31227));
	static
	{
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					{
						case 1:
							sb.append("Come back here when you reach level 20<br> to change your class.<br>");
							break;
						case 2:
							sb.append("Come back here when you reach level 40<br> to change your class.<br>");
							break;
						case 3:
							sb.append("Come back here when you reach level 76<br> to change your class.<br>");
							break;
						case 4:
