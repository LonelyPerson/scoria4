		...
		else
		{
			...
			else
			{
				...
				else if(command.startsWith("AcceptWedding"))
				{
					...
					{
						player.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_LESBO, false);
						ptarget.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_LESBO, false);
						type = 1;
					}
					else if(!player.getAppearance().getSex() && !ptarget.getAppearance().getSex())
					{
						player.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_GEY, false);
						ptarget.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_GEY, false);
						type = 2;
					}
					else
					{
						player.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_NORMAL, false);
						ptarget.getAppearance().setNameColor(Config.L2JMOD_WEDDING_NAME_COLOR_NORMAL, false);
						type = 0;
					}
