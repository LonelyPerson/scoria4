...
public class L2NpcInstance extends L2Character
{
	...
	{
		return Config.ALT_ALLOW_ATTACK_NPC;
	}
	...
	public void updateAbnormalEffect()
	{
		...
		for (L2PcInstance player : getKnownList().getKnownPlayers().values())
		{
			if (player != null)
			{
				if (getCustomNpcInstance() != null)
				{
					player.sendPacket(new CustomNpcInfo(this));
				}
				else
				{
	...
	public void showChatWindow(L2PcInstance player, int val)
	{
		...
		switch(npcId)
		{
			...
			case 31771:
			case 31772:
				if((Hero.getInstance().getHeroes() != null && Hero.getInstance().getHeroes().containsKey(player.getObjectId())) || player.isHero())
				{
	...
	public void setSpawn(L2Spawn spawn)
	{
		...
		if(_spawn != null)
		{
			if(CustomNpcInstanceManager.getInstance().isThisL2CustomNpcInstance(getNpcId()))
			{
