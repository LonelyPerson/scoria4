		...
		else if(condition == COND_REGULAR)
		{
			...
			else if(actualCommand.equalsIgnoreCase("list"))
			{
				...
				for(Auction a : auctions)
				{
					...
					items += "<tr>" + "<td width=50>" + ClanHallManager.getInstance().getClanHallById(a.getItemId()).getLocation() + "</td>" + "<td width=105><a action=\"bypass -h npc_" + getObjectId() + "_bidding " + a.getId() + "\">" + a.getItemName() + "[" + a.getBidders().size() + "]" + "</a></td>" + "<td width=55>" + format.format(a.getEndDate()) + "</td>" + "<td width=70>" + a.getStartingBid() + "</td>" + "</tr>";
				}
				items += "</table>";
