...
public class CompBlessedSpiritShotPacks extends ItemAbst
{
	public CompBlessedSpiritShotPacks()
	{
		_items = new int[]{5146, 5147, 5148, 5149, 5150, 5151, 5262, 5263, 5264, 5265, 5266, 5267};
	}
