 ...
 * 
 * @author Akumu, Maktakien
 */
public class PacketForge extends AdminAbst
{
	public PacketForge()
	{
		_commands = new String[]{"admin_forge", "admin_forge2", "admin_forge3"};
	}
	...
	{
		com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, "pforge1.htm");
	}
