...
public class Reload extends AdminAbst
{
	public Reload()
	{
		_commands = new String[]{"admin_reload"};
	}
	...
	{
		com.l2scoria.gameserver.handler.admin.impl.HelpPage.showSubMenuPage(activeChar, "reload_menu.htm");
	}
}
