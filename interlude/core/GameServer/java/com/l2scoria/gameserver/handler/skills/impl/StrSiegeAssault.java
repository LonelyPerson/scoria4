 ...
 */
public class StrSiegeAssault extends SkillAbst
{
	public StrSiegeAssault()
	{
		_types = new SkillType[]{SkillType.STRSIEGEASSAULT};
	...
	public boolean useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		{
			_log.error("Error using siege assault:" + e.getMessage(), e);
			return false;
		}
