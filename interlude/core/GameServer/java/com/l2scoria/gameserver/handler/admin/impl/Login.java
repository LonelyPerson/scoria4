 ...
 */
public class Login extends AdminAbst
{
	public Login()
	{
		_commands = new String[]{"admin_server_gm_only", "admin_server_all", "admin_server_max_player", "admin_server_list_clock", "admin_server_login"};
	}
