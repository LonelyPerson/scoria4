...
public class Polymorph extends AdminAbst
{
	public Polymorph()
	{
		_commands = new String[]{"admin_polymorph", "admin_unpolymorph", "admin_polymorph_menu", "admin_unpolymorph_menu"};
	}
	...
	{
		HelpPage.showHelpPage(activeChar, "effects_menu.htm");
	}
}
