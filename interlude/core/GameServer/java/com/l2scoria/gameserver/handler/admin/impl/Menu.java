 ...
 */
public class Menu extends AdminAbst
{
	private static final Logger _log = Logger.getLogger(Menu.class.getName());

	public Menu()
	{
		_commands = new String[]{"admin_char_manage",
	...
	private void handleKill(L2PcInstance activeChar, String player)
	{
		...
		com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, filename);
	...
	{
		com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, "charmanage.htm");
	}
