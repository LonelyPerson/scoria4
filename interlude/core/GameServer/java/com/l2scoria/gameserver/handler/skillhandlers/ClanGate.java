...
public class ClanGate implements ISkillHandler
{
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		if(activeChar instanceof L2PcInstance)
			...
			return;
		//need more checking...
		if(player.isInsideZone(L2Character.ZONE_NOLANDING) || player.isInOlympiadMode() || player.inObserverMode()
			|| player.isInsideZone(L2Character.ZONE_PVP) || GrandBossManager.getInstance().getZone(player) != null)
		{
