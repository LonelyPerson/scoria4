 ...
 */
public class Skill extends AdminAbst
{
	private static Logger _log = Logger.getLogger(Skill.class.getName());

	public Skill()
	{
		_commands = new String[]{"admin_show_skills",
				"admin_remove_skills",
				"admin_skill_list",
				"admin_skill_index",
				"admin_add_skill",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, "skills.htm");
		}
		else if(command.startsWith("admin_skill_index"))
		{
			try
			{
				...
				com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, "skills/" + val + ".htm");
				val = null;
			}
			catch(StringIndexOutOfBoundsException e)
			{
