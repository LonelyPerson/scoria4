 ...
 */
public class CursedWeapons extends AdminAbst
{

	public CursedWeapons()
	{
		_commands = new String[]{"admin_cw_info", "admin_cw_remove", "admin_cw_goto", "admin_cw_reload", "admin_cw_add", "admin_cw_info_menu"};
	}
		...
		switch(commandEnum)
		{
			...
			case admin_cw_info_menu:
				...
				for(CursedWeapon cw : cwm.getCursedWeapons())
				{
					...
					replyMSG.append("<table width=270><tr><td>Name:</td><td>").append(cw.getName()).append("</td></tr>");

					if(cw.isActivated())
					{
						L2PcInstance pl = cw.getPlayer();
						replyMSG.append("<tr><td>Weilder:</td><td>").append(pl == null ? "null" : pl.getName()).append("</td></tr>");
						replyMSG.append("<tr><td>Karma:</td><td>").append(String.valueOf(cw.getPlayerKarma())).append("</td></tr>");
						replyMSG.append("<tr><td>Kills:</td><td>").append(String.valueOf(cw.getPlayerPkKills())).append("/").append(String.valueOf(cw.getNbKills())).append("</td></tr>");
						replyMSG.append("<tr><td>Time remaining:</td><td>").append(String.valueOf(cw.getTimeLeft() / 60000)).append(" min.</td></tr>");
						replyMSG.append("<tr><td><button value=\"Remove\" action=\"bypass -h admin_cw_remove ").append(String.valueOf(itemId)).append("\" width=73 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
						replyMSG.append("<td><button value=\"Go\" action=\"bypass -h admin_cw_goto ").append(String.valueOf(itemId)).append("\" width=73 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
					}
					else if(cw.isDropped())
					{
						replyMSG.append("<tr><td>Position:</td><td>Lying on the ground</td></tr>");
						replyMSG.append("<tr><td>Time remaining:</td><td>").append(String.valueOf(cw.getTimeLeft() / 60000)).append(" min.</td></tr>");
						replyMSG.append("<tr><td>Kills:</td><td>").append(String.valueOf(cw.getNbKills())).append("</td></tr>");
						replyMSG.append("<tr><td><button value=\"Remove\" action=\"bypass -h admin_cw_remove ").append(String.valueOf(itemId)).append("\" width=73 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
						replyMSG.append("<td><button value=\"Go\" action=\"bypass -h admin_cw_goto ").append(String.valueOf(itemId)).append("\" width=73 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
					}
					else
					{
						...
						replyMSG.append("<tr><td><button value=\"Give to Target\" action=\"bypass -h admin_cw_add ").append(String.valueOf(itemId)).append("\" width=99 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td></td></tr>");
					}
