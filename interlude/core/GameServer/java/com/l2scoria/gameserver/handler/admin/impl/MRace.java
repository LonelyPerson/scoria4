 ...
 */
public class MRace extends AdminAbst
{
	public MRace()
	{
		_commands = new String[]{"admin_mons"};
	}
	...
	private void handleSendPacket(L2PcInstance activeChar)
	{
		...
		com.l2scoria.gameserver.model.entity.MonsterRace race = com.l2scoria.gameserver.model.entity.MonsterRace.getInstance();
	...
	class RunEnd implements Runnable
	{
		...
		public void run()
		{
			...
			for(int i = 0; i < 8; i++)
			{
				obj = new DeleteObject(com.l2scoria.gameserver.model.entity.MonsterRace.getInstance().getMonsters()[i]);
