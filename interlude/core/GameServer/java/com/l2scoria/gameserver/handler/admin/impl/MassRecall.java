 ...
 * 
 * @author Akumu, Yamaneko
 */
public class MassRecall extends AdminAbst
{
	public MassRecall()
	{
		_commands = new String[]{"admin_recallclan", "admin_recallparty", "admin_recallally"};
	}
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if(command.startsWith("admin_recallclan"))
		{
			try
			{
				...
				val = null;
				L2PcInstance[] m = clan.getOnlineMembers(0);
			...
			try
			{
				...
				else
				{
					for(L2Clan aclan : ClanTable.getInstance().getClans())
					{
						...
						{
							L2PcInstance[] m = aclan.getOnlineMembers(0);
