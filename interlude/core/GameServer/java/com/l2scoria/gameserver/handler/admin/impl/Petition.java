 ...
 * @author Akumu, Tempy
 */
public class Petition extends AdminAbst
{
	public Petition()
	{
		_commands = new String[]{"admin_view_petitions", "admin_view_petition", "admin_accept_petition", "admin_reject_petition", "admin_reset_petitions"};
	}
