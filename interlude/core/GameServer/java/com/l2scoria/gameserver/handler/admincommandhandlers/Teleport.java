 ...
 */
public class Teleport extends Admin
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			HelpPage.showHelpPage(activeChar, "teleports.htm");
		}

		if(command.equals("admin_show_moves_other"))
		{
			HelpPage.showHelpPage(activeChar, "tele/other.html");
		}
	...
	{
		HelpPage.showHelpPage(activeChar, "move.htm");
	}
