 ...
 */
public class Effects extends AdminAbst
{
	public Effects()
	{
		_commands = new String[]{"admin_invis",
				"admin_invisible",
				"admin_vis",
				"admin_visible",
				"admin_invis_menu",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			HelpPage.showHelpPage(activeChar, "songs/songs.htm");
		}
		else if(command.startsWith("admin_play_sounds"))
		{
			try
			{
				HelpPage.showHelpPage(activeChar, "songs/songs" + command.substring(17) + ".htm");
			}
	...
	private void showMainPage(L2PcInstance activeChar, String command)
	{
		...
		HelpPage.showHelpPage(activeChar, filename + ".htm");
		filename = null;
	}
}
