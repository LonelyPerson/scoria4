 ...
 */
public class Enchant extends AdminAbst
{
	public Enchant()
	{
		_commands = new String[]{"admin_seteh",//6
				"admin_setec",//10
				"admin_seteg",//9
				"admin_setel",//11
				"admin_seteb",//12
	...
	private void setEnchant(L2PcInstance activeChar, int ench, int armorType)
	{
		...
		if(itemInstance != null)
		{
			...
			{
				player.sendMessage("A GM tried to overenchant you. You will be panished.");
				Util.handleIllegalPlayerAction(player, "The player " + player.getName() + " has been panished.", Config.DEFAULT_PUNISH);
				activeChar.sendMessage("You tried to overenchant somebody. You will both be panished.");
				Util.handleIllegalPlayerAction(activeChar, "The GM " + activeChar.getName() + " has overenchanted the player " + player.getName(), Config.DEFAULT_PUNISH);
			}
			else
			{
				// set enchant value
	...
	{
		HelpPage.showHelpPage(activeChar, "enchant.htm");
	}
}
