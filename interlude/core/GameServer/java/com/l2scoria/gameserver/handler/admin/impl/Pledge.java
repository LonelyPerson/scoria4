 ...
 */
public class Pledge extends AdminAbst
{
	public Pledge()
	{
		_commands = new String[]{"admin_pledge"};
	}
	...
	{
		com.l2scoria.gameserver.handler.admin.impl.HelpPage.showHelpPage(activeChar, "game_menu.htm");
	}
