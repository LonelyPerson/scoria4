...
{
	private final static Logger _log = Logger.getLogger(AdminEditChar.class.getName());
	...
	private void listCharacters(L2PcInstance activeChar, int page)
	{
		...
		{ //Add player info into new Table row
			...
			replyMSG.append("<tr><td width=80><a action=\"bypass -h admin_character_info " + players[i].getName() + "\">" + name + "</a></td><td width=110>" + players[i].getTemplate().className + "</td><td width=40>" + players[i].getLevel() + "</td></tr>");
		}
