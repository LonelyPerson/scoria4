...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	public L2NpcTemplate(StatsSet set)
	{
		...
		_npcStatsSet = set;
		_teachInfo = null;
		String ai_type = set.getString("ai_type", "fighter");
		if (ai_type.equalsIgnoreCase("archer"))
			ai = AIType.ARCHER;
		else if (ai_type.equalsIgnoreCase("balanced"))
			ai = AIType.BALANCED;
		else if (ai_type.equalsIgnoreCase("mage"))
			ai = AIType.MAGE;
		else if (ai_type.equalsIgnoreCase("healer"))
			ai = AIType.HEALER;
		else
			ai = AIType.FIGHTER;
	}
