...
public class L2TopDeamon implements Runnable
{
	...
	private static Logger _log = Logger.getLogger(L2TopDeamon.class.getName());
	...
	private L2TopDeamon()
	{
		...
		if (PowerPakConfig.L2TOPDEMON_ENABLED) try
		{
			...
			_log.warning("L2TopDeamon: Error connection to database: " + e);
		}
	}
	...
	private boolean checkVotes()
	{
		try {
			...
			_log.info("L2TopDeamon: Error while reading data.");
		}
		return false;
