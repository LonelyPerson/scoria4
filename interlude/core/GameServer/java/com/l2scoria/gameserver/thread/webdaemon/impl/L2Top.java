 ...
 * L2Top
 */
public class L2Top implements IWebDaemon
{

	private static Logger _log = Logger.getLogger(L2Top.class);
	...
	public String getUrl()
	{
		...
		else if (Config.L2TOP_REW_MODE == Config.RewardMode.WEB)
		{
		...
		while ((line = reader.readLine()) != null)
		{
			if (line.contains("\t"))
			{
				...
				if (voteDate.after(_lastVote))
				{
					...
					StoreVote.store(this, charName, voteDate, !Config.L2TOPDEMON_IGNOREFIRST || !_firstRun);
					votes++;
	...
	{
		return Config.L2TOPDEMON_POLL_INVERVAL * 60000L;
	}
}
