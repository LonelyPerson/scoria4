...
public class CrestCache
{
	...
	private FastMap<Integer, byte[]> _cachePledge = new FastMap<Integer, byte[]>();
	private FastMap<Integer, byte[]> _cachePledgeLarge = new FastMap<Integer, byte[]>();
	private FastMap<Integer, byte[]> _cacheAlly = new FastMap<Integer, byte[]>();
