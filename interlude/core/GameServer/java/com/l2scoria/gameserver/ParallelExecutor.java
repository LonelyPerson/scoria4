...
import com.l2scoria.gameserver.thread.ThreadPoolManager.PriorityThreadFactory;
...
public class ParallelExecutor
{
	...
	{
		executor = new ThreadPoolExecutor(cores, cores, 1, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new PriorityThreadFactory(name, prio, false));
	}
