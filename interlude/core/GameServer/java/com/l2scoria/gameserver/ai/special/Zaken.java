...
public class Zaken extends Quest
{
	...
	{
		-3488, -3488, -3488, -3488, -3488, -3216, -3216, -3216, -3216, -3216, -2952, -2952, -2952, -2952, -2952
	};
	...
	public Zaken(int questId, String name, String descr)
	{
		...
		addEventId(ZAKEN, Quest.QuestEventType.ON_SPELL_FINISHED);
		addEventId(ZAKEN, Quest.QuestEventType.ON_AGGRO_RANGE_ENTER);
		addEventId(ZAKEN, Quest.QuestEventType.ON_FACTION_CALL);
		
		addEventId(doll_blader_b, Quest.QuestEventType.ON_KILL);
		addEventId(vale_master_b, Quest.QuestEventType.ON_KILL);
		addEventId(pirates_zombie_captain_b, Quest.QuestEventType.ON_KILL);
		addEventId(pirates_zombie_b, Quest.QuestEventType.ON_KILL);
	...
	public String onFactionCall(L2NpcInstance npc, L2NpcInstance caller, L2PcInstance attacker, boolean isPet)
	{
		...
		{
			if (npc.getAI().getIntention() == CtrlIntention.AI_INTENTION_IDLE && _ai0 == 0 && Rnd.get((30 * 15)) < 1)
			{
				_ai0 = 1;
				_ai1 = caller.getX();
				_ai2 = caller.getY();
