				...
				if("list".equalsIgnoreCase(n.getNodeName()))
				{
					for(Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
					{
						if("zone".equalsIgnoreCase(d.getNodeName()))
						{
							...
							else if(zoneType.equals("Fight"))
							{
								temp = new L2FightZone(zoneId);
							}
							...
							else if(zoneType.equals("SummonOff"))
							{
								temp = new L2SummonOff(zoneId);
							}
							...
							else if(temp instanceof L2FightZone)
							{
								ArenaManager.getInstance().addFight((L2FightZone) temp);
							}
