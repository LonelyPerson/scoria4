 ...
 * It's initialized at the very begin of startup, and later JIT will
 * optimize<br>
 * away debug/unused code.<br>
 * <br>
 * <li>ArrayList & List РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…
 * РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…
 * РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… FastList
 */
public final class Config {
    ...
    public static void loadPvpConfig() {
        ...
        try {
            ...
            /**
             * Enable Pk Info mod. Displays number of times player has killed
             * other
             */
    ...
    public static boolean SS_ANTI_CRY_STUN;
    ...
    public static void loadPHYSICSConfig() {
        ...
        try {
            ...
            SS_ANTI_CRY_STUN = Boolean.parseBoolean(PHYSICSSetting.getProperty("EnableAntiCryStunSystem", "false"));
        } catch (Exception e) {
            e.printStackTrace();
