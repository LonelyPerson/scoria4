...
public class Config
{
	...
	private Config()
	{
		...
		System.out.println("Loading: " + MMO_CONFIG + ".");
		try
		{
			...
			// buffer options
			NETWORK_READ_BUFFER_SIZE = TypeFormat.parseInt(mmoSetting.getProperty("NetworkReadBufferSize", "128"));
			NETWORK_WRITE_BUFFER_SIZE = TypeFormat.parseInt(mmoSetting.getProperty("NetworkWriteBufferSize", "128"));
